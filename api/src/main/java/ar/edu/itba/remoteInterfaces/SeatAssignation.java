...
public interface SeatAssignation extends Remote {
     ...
     */
    boolean isSeatFree(Seat seat, String flightCode) throws RemoteException;
     ...
     * @throws RemoteException
     */
    void asignSeat(Passenger passenger) throws RemoteException;
     ...
     * @throws RemoteException
     */
    void movePassenger(Passenger passenger) throws RemoteException;
